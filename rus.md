...
JS моделей с кодом страницы, для уменьшения программных заготовок и улучшения
...
(расширения get/set). Внимание — второй метод лучше. См. tl;dr блок в конце
статьи.
...
(отсутсвует проверка на "грязность свойств объекта"), в некоторых случаях 
